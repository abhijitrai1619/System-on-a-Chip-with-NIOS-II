...
module Embed_mm_interconnect_1 (
	...
	wire         cmd_mux_002_src_valid;                                                            // cmd_mux_002:src_valid -> slide_pio_s1_agent:cp_valid
	wire  [85:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> slide_pio_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // slide_pio_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> slide_pio_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                    // cmd_mux_002:src_startofpacket -> slide_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                      // cmd_mux_002:src_endofpacket -> slide_pio_s1_agent:cp_endofpacket
	...
	wire  [85:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> led_pio_s1_agent:cp_data
	...
	wire         slide_pio_s1_agent_rp_valid;                                                      // slide_pio_s1_agent:rp_valid -> router_003:sink_valid
	wire  [85:0] slide_pio_s1_agent_rp_data;                                                       // slide_pio_s1_agent:rp_data -> router_003:sink_data
	wire         slide_pio_s1_agent_rp_ready;                                                      // router_003:sink_ready -> slide_pio_s1_agent:rp_ready
	wire         slide_pio_s1_agent_rp_startofpacket;                                              // slide_pio_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         slide_pio_s1_agent_rp_endofpacket;                                                // slide_pio_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [85:0] led_pio_s1_agent_rp_data;                                                         // led_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire         slide_pio_s1_agent_rdata_fifo_src_valid;                                          // slide_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] slide_pio_s1_agent_rdata_fifo_src_data;                                           // slide_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         slide_pio_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_002:in_0_ready -> slide_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                // avalon_st_adapter_002:out_0_valid -> slide_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                 // avalon_st_adapter_002:out_0_data -> slide_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                // slide_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                // avalon_st_adapter_002:out_0_error -> slide_pio_s1_agent:rdata_fifo_sink_error
